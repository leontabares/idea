...
(function( $ ) {
  ...
  $.when( xhr_dlogin, xhr_toolbar, xhr_mchat, xhr_options ).done(function(r1, r2, r3, r4) {
    ...
    $( document ).on("click", ".user-button", function() {
      ...
      //Set position
      $( "#Dialog" + iduser ).dialog( "option", "position", { my: "left bottom", at: "left top-3", of: this, collision: "flip, none" });
    });
              ...
              if ( (e.which == 13) && !event.shiftKey ) {
                ...
                if (msg !== "") {
                  ...
                  socket.emit('message', { 'user': user, 'msg': msg }, function (data) {
                    ...
                    // FIXME
                    // Set dialog position
                    main.dialog( "option", "position", { my: "left bottom", at: "left top-3", of: "#user-button-"+id, collision: "flip, none" });
                  });
                }
              }
              return false;
    ...
    function main_chat_set_position ( pos ) {
      ...
      $( "#main-users-resizer" ).position({ my: "left bottom", at: "left top", of: "#main", collision: "flip, none" });
    }
    ...
    function handle_incoming(recv) {
      ...
      if (action == 'message') {
        ...
        // FIXME
        // Set dialog position
        main.dialog( "option", "position", { my: "left bottom", at: "left top-3", of: "#user-button-"+iduser, collision: "flip, none" });
      }
